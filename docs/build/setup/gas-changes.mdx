...
To learn more about gas fees in the context of Sui Tokenomics, see [Gas in Sui](../../learn/economics//gas-in-sui.mdx).
...
1. Execution is successful, but charging for storage causes _Out of Gas_.
