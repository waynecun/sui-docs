...
## Transactions flow - example {#example-tx-flow}
...
## Limits on transactions, objects, and data {#limits}
...
- See the [Move tutorial](../../build/create-smart-contracts/smart-contracts.mdx) to develop Sui smart contracts.
- Transactions take objects as input and produce objects as output--learn about the [objects](../core-concepts/objects.mdx), their structure and attributes.
- Transactions are executed by Sui [validators](../../contribute/nodes/validator.mdx).
