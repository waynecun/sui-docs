...
This page lists applications that can work in the single-writer model defined as [simple transactions](../core-concepts/how-sui-works.mdx#simple-transactions) in Sui.
