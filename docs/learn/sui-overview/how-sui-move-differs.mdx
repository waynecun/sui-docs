...
## Object with key ability, globally unique IDs {#global-unique-ids}
...
See [Entry functions](../../build/create-smart-contracts/smart-contracts.mdx#entry-functions).

## Conclusion

In summary, Sui takes advantage of Move’s security and flexibility and enhances it with the features described above to vastly improve throughput, reduce delays in finality, and make Sui Move programming easier. Now see [how Sui works](../core-concepts/how-sui-works.mdx).
