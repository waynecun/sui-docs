...
Sui is a [smart contract](../../reference/sui-framework/sui-glossary.mdx#smart-contract) platform maintained by a permissionless set of [validators](../../reference/sui-framework/sui-glossary.mdx#validator) that play a role similar to validators or miners in other blockchain systems.
...
Sui is backed by a number of state-of-the-art [peer-reviewed works](../../reference/sui-framework//research-papers.mdx) and years of open source development.
...
## Parallel agreement - a breakthrough in system design {#parallelism}
...
- [Narwhal and Bullshark](../../learn/core-concepts/consensus-engine.mdx) DAG-based mempool and efficient Byzantine Fault Tolerant (BFT) consensus
...
## Unparalleled scalability, immediate settlement {#scalability-immediate-settlement}
...
## A safe smart contract language accessible to mainstream developers {#safety}
...
## Ability to define rich and composable on-chain assets {#composability}
...
## Better user experience for web3 apps {#user-experience}
