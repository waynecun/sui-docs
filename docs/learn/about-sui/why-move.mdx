...
In Sui, you write [Smart Contracts](../../build/create-smart-contracts/smart-contracts.mdx) with the Sui Move Programming language. This page links to key [Move](<https://golden.com/wiki/Move_(programming_language)-MNA4DZ6>) resources and compares the [Move](https://github.com/move-language/move/tree/main/language/documentation) and Solidity programming languages. For a full description of the issues with traditional smart contract languages, see the [Move Problem Statement](https://github.com/MystenLabs/awesome-move/blob/main/docs/problem_statement.mdx).

## Sui Move

First, note Move is based upon the well-supported [Rust](https://www.rust-lang.org/) programming language. And [Sui Move differs from core Move](./how-sui-move-differs.mdx) in subtle yet distinct ways. Here are resources to ramp up on Sui Move:
...
This section aggregates links to external resources on the Move programming language. See also our [Smart Contracts with Move](../../build/create-smart-contracts/smart-contracts.mdx) page and [Move Programming with Objects](../../build/program-with-objects/using-objects.mdx) tutorial series for key Move resources in this site.
...
- [Tutorial](https://github.com/move-language/move/blob/main/language/documentation/tutorial/README.mdx) - A step-by-step guide through writing a Move module.
- [Book](https://github.com/move-language/move/blob/main/language/documentation/book/src/introduction.mdx) - A summary with pages on [various topics](https://github.com/move-language/move/tree/main/language/documentation/book/src).
...
- [Awesome Move](https://github.com/MystenLabs/awesome-move/blob/main/README.mdx) - A summary of resources related to Move, from blockchains through code samples.
