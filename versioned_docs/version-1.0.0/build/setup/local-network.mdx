...
Install the necessary [prerequisites](../../build/setup/cli/install-sui.mdx#prerequisites) for Sui.

## Install Sui

Use the steps in this section to install the `sui-test-validator` to run a local network. To install Sui to build or for other purposes, use the steps in the [Install Sui](../setup/cli/install-sui.mdx) topic.
...
For more details about Sui Explorer, see the [Explorer README](https://github.com/MystenLabs/sui/blob/main/apps/explorer/README.mdx#set-up).
...
Consult the Sui Wallet [Readme](https://github.com/MystenLabs/sui/blob/main/apps/wallet/README.mdx#install-the-extension-to-chrome) for more information on working with a locally built wallet on Chrome.
