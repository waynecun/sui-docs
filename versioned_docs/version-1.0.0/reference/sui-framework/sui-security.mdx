...
The Sui Move smart contract language is designed with ease of audit and verification in mind. You may be interested in our introduction to [Smart Contracts in Move](../../build/create-smart-contracts/smart-contracts.mdx).
...
### Censorship-resistance and openness {#censorship-resistance}
